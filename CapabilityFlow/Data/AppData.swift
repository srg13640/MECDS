...
struct AppData {
    ...
    let processSteps: [ProcessStep] = [
        ...
        ProcessStep(
            ...
            detailedDescription: "The problem is placed in the context of the future operating environment. T2COM, the Futures and Concepts Center (FCC), and the Directorate of Concepts translate strategic direction into concepts that describe how the future Army needs to fight, surfacing the assumptions that everything downstream will depend on.",
        ...
        ProcessStep(
            ...
            detailedDescription: "A Force Capability Division (FCD) takes primary ownership of the functional problem and frames it as capability gaps and learning demands. Other FCDs are identified as supporting or affected. Clear ownership here prevents the most common failure mode downstream: no one accountable for the problem as a whole.",
            organizations: ["FCDs", "C2 FCD", "Cyber FCD", "Fires FCD", "Intelligence FCD", "Maneuver FCD", "Aviation FCD", "Sustainment FCD", "Medical FCD", "Protection FCD"],
        ...
        ProcessStep(
            ...
            detailedDescription: "AMC, ASC, gaining units, CAC, TRADOC/T2COM, and the sustainment enterprise field the capability and integrate it into formations — with the training, doctrine, and sustainment needed to actually use it. A capability that units cannot absorb is not really fielded.",
            organizations: ["AMC", "ASC", "Gaining units", "CAC", "TRADOC/T2COM", "Sustainment enterprise"],
    ...
    let organizations: [Organization] = [
        Organization(
            ...
            abbreviation: "FCC",
            category: .concepts,
            plainEnglishRole: "The Army's lead for understanding the future operating environment and framing the operational problems modernization must solve.",
            owns: ["Future force design and concepts", "Functional problem framing through its FCDs", "Experimentation and requirements integration roles"],
            doesNotOwn: ["Acquisition execution", "Resourcing decisions", "Operational test", "Doctrine and training (CAC)"],
            keyRelationships: ["CAC", "DEVCOM", "HQDA G-8", "ASA(ALT)", "JMC", "TDAC"],
        ...
        Organization(
            ...
            abbreviation: "DoC",
            category: .concepts,
            plainEnglishRole: "Writes the concepts that describe how the future Army needs to fight.",
            owns: ["Army warfighting concepts", "Future operating environment framing"],
        ...
        Organization(
            ...
            plainEnglishRole: "Integrates evidence and FCD inputs into coherent, justified requirements.",
            owns: ["Requirements integration across FCDs", "Coherence of requirements documentation"],
        ...
        Organization(
            id: "c2fcd",
            name: "Command & Control Force Capability Division",
            abbreviation: "C2 FCD",
            category: .functional,
            plainEnglishRole: "Owns the command-and-control functional problem and its capability gaps.",
        ...
        Organization(
            id: "fcds",
            name: "Other Force Capability Divisions",
            abbreviation: "FCDs",
            category: .functional,
            plainEnglishRole: "Each FCD owns a functional problem area (Fires, Intelligence, Maneuver, Aviation, Sustainment, Medical, Protection, Cyber, etc.).",
            owns: ["Functional problem framing in their area", "Capability gaps and learning demands"],
        ...
        Organization(
            ...
            plainEnglishRole: "The Army's lead for leader development, doctrine, training, and combined-arms integration.",
            ...
            keyRelationships: ["FCC", "Centers of Excellence", "TRADOC/T2COM", "Gaining units"],
        ...
        Organization(
            ...
            plainEnglishRole: "The Army's primary science and technology organization; assesses feasibility and builds prototypes.",
            owns: ["Science and technology", "Technical feasibility", "Prototyping"],
            doesNotOwn: ["Requirements validation", "Acquisition execution", "Resourcing"],
            keyRelationships: ["ARL", "C5ISR Center", "FCDs", "ASA(ALT)", "Industry"],
        ...
        Organization(
            ...
            abbreviation: "MRDC",
            category: .scienceTech,
            plainEnglishRole: "Leads Army medical science and technology and medical materiel development.",
            owns: ["Medical S&T", "Medical materiel development"],
            doesNotOwn: ["Non-medical acquisition", "Requirements validation"],
            keyRelationships: ["DEVCOM", "Medical FCD", "ASA(ALT)"],
        ...
        Organization(
            id: "tdac",
            name: "TRADOC Data and Analysis Center",
            abbreviation: "TDAC",
            category: .analysis,
            plainEnglishRole: "Provides operational analysis, modeling and simulation, and evidence to inform decisions.",
            owns: ["Operational analysis", "Modeling and simulation", "Formation effectiveness analysis"],
            doesNotOwn: ["Requirements authorship", "Acquisition", "Test execution"],
            keyRelationships: ["FCC", "FCDs", "CAA", "ATEC"],
            typicalOutputs: ["Analysis reports", "Modeling and simulation results", "Risk assessments"],
        ...
        Organization(
            ...
            abbreviation: "JMC",
            category: .experimentation,
            plainEnglishRole: "Plans and executes large-scale experimentation, including campaigns like Project Convergence.",
            owns: ["Experimentation execution", "Joint and Army experimentation campaigns"],
            doesNotOwn: ["Operational test (ATEC)", "Requirements", "Acquisition"],
            keyRelationships: ["FCC", "FCDs", "Operational units", "ASA(ALT)"],
            typicalOutputs: ["Experimentation results", "Military utility insights"],
            whenToInvolve: "When concepts and prototypes need to be experimented with at scale.",
            relatedProcessSteps: ["s6"]
        ),
        Organization(
            id: "usaric",
            name: "75th U.S. Army Innovation Command",
            abbreviation: "75th USARIC",
            category: .experimentation,
            plainEnglishRole: "Reserve-component command that connects innovation, experimentation, and operational learning.",
            owns: ["Innovation and experimentation support", "Operational learning integration"],
            doesNotOwn: ["Requirements validation", "Acquisition"],
            keyRelationships: ["JMC", "FCC", "Operational units"],
            typicalOutputs: ["Innovation insights", "Experimentation support"],
            whenToInvolve: "When reserve-component or distributed innovation and experimentation help.",
            relatedProcessSteps: ["s6"]
        ),
        Organization(
            id: "g8fd",
    ...
    let glossary: [GlossaryTerm] = [
        ...
        GlossaryTerm(id: "jcids", term: "JCIDS", definition: "Joint Capabilities Integration and Development System — the Joint process for identifying and validating capability requirements.", whyItMatters: "It governs how Joint requirements are validated and is relevant when a need is Joint.", example: "Because the need was Joint, the requirement went through JCIDS."),
        ...
        GlossaryTerm(id: "jroc", term: "JROC", definition: "Joint Requirements Oversight Council — the senior Joint body that validates major requirements.", whyItMatters: "It is the Joint decision authority for significant capability requirements.", example: "The major requirement required JROC validation."),
        ...
        GlossaryTerm(id: "tdac", term: "TDAC", definition: "TRADOC Data and Analysis Center — provides operational analysis and modeling and simulation.", whyItMatters: "It turns observations and data into rigorous, defensible evidence.", example: "TDAC's analysis showed the formation effect the capability would produce."),
        GlossaryTerm(id: "fcd", term: "FCD", definition: "Force Capability Division — an FCC division that owns a functional problem area.", whyItMatters: "FCDs are where functional capability problems get owned and framed.", example: "The C2 FCD owned the command-and-control problem."),
        GlossaryTerm(id: "t2com", term: "T2COM", definition: "TRADOC's transformation/Army Futures-aligned command element responsible for concepts and transformation (terminology depends on current organization).", whyItMatters: "It connects concepts, doctrine, training, and transformation.", example: "T2COM helped frame the future-force context."),
        GlossaryTerm(id: "fcc", term: "FCC", definition: "Futures and Concepts Center — leads future-force design, concepts, and capability problem framing.", whyItMatters: "It is the front of the capability-development ecosystem.", example: "The FCC framed the operational problem before requirements work began."),
        ...
        GlossaryTerm(id: "jmc", term: "JMC", definition: "Joint Modernization Command — plans and executes large-scale experimentation like Project Convergence.", whyItMatters: "It is where concepts and prototypes meet Soldiers at scale.", example: "JMC ran the experiment that tested the new concept.")
    ]

    // MARK: Quiz questions

    let quizQuestions: [QuizQuestion] = [
        QuizQuestion(id: "q1", category: "Who first?", prompt: "A new operational problem about command and control has just been identified. Who should generally own and frame the functional problem first?", options: ["A PEO", "The C2 FCD", "ATEC", "A contracting officer"], correctIndex: 1, explanation: "Functional problem ownership typically sits with the relevant Force Capability Division — here, the C2 FCD — before acquisition or test organizations engage."),
