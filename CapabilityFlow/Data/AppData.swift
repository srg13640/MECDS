...
struct AppData {
    ...
    let processSteps: [ProcessStep] = [
        ...
        ProcessStep(
            ...
            detailedDescription: "AMC, ASC, gaining units, CAC, T2COM, and the sustainment enterprise field the capability and integrate it into formations — with the training, doctrine, and sustainment needed to actually use it. A capability that units cannot absorb is not really fielded.",
            organizations: ["AMC", "ASC", "Gaining units", "CAC", "T2COM", "Sustainment enterprise"],
    ...
    let organizations: [Organization] = [
        ...
        Organization(
            ...
            keyRelationships: ["FCC", "Centers of Excellence", "T2COM", "Gaining units"],
